      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xs text-pink-400 font-mono hidden sm:inline">MEDIA ENGINE</span>
          </Link>
      ...
      <main className="max-w-6xl mx-auto px-4 pt-28">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="solar-badge bg-pink-500/20 text-pink-400 border border-pink-500/30 mb-3">
            🎥 Generador Autónomo de Reels, Shorts & TikTok con Datos Solares en Vivo
          </div>
          <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight mb-3">
            Motor de Viralización Científica
          </h1>
          <p className="text-sm text-white/60">
            Cada 60 segundos, este módulo analiza los satélites de NASA y NOAA y genera automáticamente guiones profesionales optimizados para retención de audiencia y monetización en redes sociales para <strong className="text-solar-400">JESÚS BARRIOS</strong>.
          </p>
        </div>
        ...
        <div className="solar-card p-6 md:p-8 bg-black/60 border border-white/10 rounded-3xl relative">
          ...
          <div className="space-y-4 mb-8">
            <h3 className="text-xs font-mono uppercase text-white/50 tracking-wider">Storyboard de Grabación (Slide por Slide):</h3>
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-3">
            <div className="text-xs text-white/60">
              🎵 <strong>Sugerencia de Audio de Fondo:</strong> {scriptData?.music_suggestion}
            </div>
